...
define(["core/Utils", "core/Point", "libs/connect"], function (Utils,Point,ConnectJs) {
    ...
    var AnimUtils = {
        ...
        getAllChildrenAnimNodesOfTree: function (internalBinaryTree) {
            var children = [];
            Utils.inorder(internalBinaryTree, function (binaryTree) {
                children = children.concat(binaryTree.getAnimNode());
            });
